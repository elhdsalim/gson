...
public final class Gson {
  ...
  private <T> TypeAdapter<T> typeCandidateTypeAdapter(TypeToken<T> type,
      Map<TypeToken<?>, TypeAdapter<?>> threadCalls) {
  ...
  public <T> TypeAdapter<T> getAdapter(TypeToken<T> type) {
    ...
    try {
      candidate = typeCandidateTypeAdapter(type, threadCalls);
    } finally {
